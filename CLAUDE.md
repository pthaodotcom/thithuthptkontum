# CLAUDE.md — Rule coding cho webapp Thi thử Trực tuyến THPT
...
10. **Email Gmail mặc định ở chế độ stub** (`EMAIL_ENABLED=false`). Chỉ bật gửi thật khi tài khoản Gmail đã có App Password; bí mật SMTP chỉ được dùng ở server.
